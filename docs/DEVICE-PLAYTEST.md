...
3. Queue two workers: each should arrive six seconds apart, with costs paid once. Cancel a queued recruit and confirm a full refund. Watch the food net rate as workers arrive; use Workers to compare farm production against upkeep. Assign workers. Swipe the worker drawer vertically; labels and controls should stay within its sides. Pan and pinch the level; gestures must not place buildings accidentally.
